...
export function Updates({ state }: any) {
  ...
  const updates = [
    { version: '3.0.0', date: '21/04/2026', desc: 'Mise à jour v3.0 Stabilité & Ergonomie : Mode Sombre implémenté. Mises à jour intelligentes (l\'auto-actualisation attend désormais que vous ayez envoyé votre brouillon en cours pour ne rien effacer). Menu mobile 100% écran. Correction des espaces vides sur grand écran. Actions message (supprimer, sélectionner, muter) disposées horizontalement de droite à gauche avec de toutes nouvelles infobulles. Suppression intégrale rétablie : supprimer un SMS ou un groupe supprime désormais formellement *tous* les messages du serveur de façon irréversible. Correction visibilité globale des textes de saisie dans toute l\'application (mode clair fluide). Optimisation de tous les paramètres : boutons de confirmation discrets.' },
