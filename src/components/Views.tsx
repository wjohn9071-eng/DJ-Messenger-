...
export function Updates() {
  const updates = [
    { version: '2.9.0', date: '13/04/2026', desc: 'Gestion avancée des groupes : Liste des membres en privé, filtrage Admin/Sous-Admins en public. Système de bannissement temporaire (3 semaines) avec limite de 5 fois. Permissions étendues pour les Sous-Admins. Suppression simplifiée des messages par clic. Suppression des discussions vides. Révélation des messages supprimés pour Super Admins.' },
